    ...
    <main className="max-w-7xl mx-auto px-4 py-12 md:py-20">
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-slate-500">
          Current theme: <strong>{theme ?? "loading..."}</strong>
        </p>
      </div>
        ...
        <div className="lg:col-span-4 space-y-10">
          ...
          <div className={`p-8 rounded-3xl shadow-xl ${isDarkMode ? 'bg-zinc-900/50 border border-zinc-800' : 'bg-indigo-50'}`}>
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-xl text-sm mb-3 border focus:ring-2 focus:ring-indigo-600 focus:outline-none ${isDarkMode ? 'bg-zinc-800 border-zinc-700 text-white' : 'bg-white border-slate-200 text-slate-900'
                }`}
            />
